...
function sendData($email) {
    ...
    try {
        ...
        $mail->Body    = 'Hello, It\'s Vlad from <a href="https://perfomante.io">Perfomante.io</a><br>You left a request on our website. It would be great to know about your project and create videos for you.<br><br>Let\'s schedule a call? You can book the time here: <a href="https://calendly.com/vlad_davidovich/30min">https://calendly.com/vlad_davidovich/30min</a>';
        $mail->AltBody = 'Hello, It\'s Vlad from <a href="https://perfomante.io">Perfomante.io</a><br>You left a request on our website. It would be great to know about your project and create videos for you.<br><br>Let\'s schedule a call? You can book the time here: <a href="https://calendly.com/vlad_davidovich/30min">https://calendly.com/vlad_davidovich/30min</a>';
